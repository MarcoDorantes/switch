...
namespace nutility
{
  ...
  public class Switch : IEnumerable<string>
  {
    ...
    private Dictionary<Type, nutility.Switch.InstanceCreator> creators;
    ...
    public Switch(string[] opts, Dictionary<Type, nutility.Switch.InstanceCreator> creators) : this(opts, StringComparer.CurrentCultureIgnoreCase, creators, null) { }
    ...
    public Switch(string[] opts, StringComparer comparer, Dictionary<Type, nutility.Switch.InstanceCreator> creators, IResponseProvider response_provider)
    {
    ...
    public Dictionary<Type, nutility.Switch.InstanceCreator> ConstructorMap
    {
      get { return creators; }
      set { creators = value; }
    }
